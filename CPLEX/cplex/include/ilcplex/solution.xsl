...
<xsl:template match="CPLEXSolution/objectives">
  <br> </br>
  <table summary="Objectives" border="1" cellpadding="6">
    <tr>
      <th colspan="4"><b>Objectives</b></th>
    </tr>
    <tr>
       <th><b><xsl:text>Index</xsl:text></b></th>
       <th><b><xsl:text>Name</xsl:text></b></th>
       <th><b><xsl:text>Value</xsl:text></b></th>
       <th><b><xsl:text>Priority</xsl:text></b></th>
       <th><b><xsl:text>Weight</xsl:text></b></th>
    </tr>
...
<xsl:template match="CPLEXSolution/blendedObjectives">
  <br> </br>
  <table summary="BlendedObjectives" border="1" cellpadding="6">
    <tr>
      <th colspan="4"><b>BlendedObjectives</b></th>
    </tr>
    <tr>
       <th><b><xsl:text>Priority</xsl:text></b></th>
       <th><b><xsl:text>Value</xsl:text></b></th>
    </tr>
    <xsl:for-each select="blendedObjective">
      <tr>
        <td align="right"><xsl:value-of select="@priority"/></td>
        <td align="right"><xsl:value-of select="@value"/></td> 
      </tr>
