...
for file_index in $(seq $MinFileIndex $files_per_task $MaxFileIndex); do
    ...
    echo "./RunSingleFile/BatchDARunMultiChain.run --N $N --begin $file_index --end $end_index &"
    ./RunSingleFile/BatchDARunMultiChain.run --N $N --begin $file_index --end $end_index &
done
